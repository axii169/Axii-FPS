...
4) Если в игре присутствует скрин-тиринг (разрывы изображения), то велика вероятность что данные будут некорректные. В основном актуально для некоторых игр с PS3/Xbox 360
